#!/usr/bin/env bash
# Generic black colors

hc remove_attr theme.my_black_highlight
...
hc new_attr string theme.my_black_highlight '#303030'
...
hc attr theme.active.color       $(hc attr theme.my_black_highlight)
hc attr theme.active.inner_color $(hc attr theme.my_black_highlight)
hc attr theme.active.outer_color $(hc attr theme.my_black_highlight)
